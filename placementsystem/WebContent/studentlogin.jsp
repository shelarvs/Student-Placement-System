...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
  ...
  <div class="form">
  <br><br><br><br><br>
    <form action="student_login_action.jsp" class="login-form">
	
<h1>STUDENT LOGIN</h1>
<br>
<br>
      <input name="s_mail" type="email" placeholder="Enter Email id"
          pattern=".+.com" size="30" required
           title="Please Enter Valid email address"/>
      <input name="s_pass" type="password" placeholder="Enter password"/>
      <button>LOGIN</button>
