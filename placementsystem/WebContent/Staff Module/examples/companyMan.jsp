          ...
          <div class="container-fluid">
            <div class="card card-plain">
              <div class="card-header card-header-primary">
                ...
                <p class="card-category">Remove Company</p>
              </div>
				  <div class="card-body">
...
int i=0;
                      ...
                      while(resultSet.next()){ %>
                        <tr>
                          ...
                          <td>
                           <%=resultSet.getString("c_Company_type")%>
                          </td>
                          <td>
                           <%=resultSet.getString("c_ESTB_year")%>
                          </td>
                          <td>
                            <%=resultSet.getString("c_Address")%>
                          </td>
                          <td>
                           <%=resultSet.getString("c_Technology")%>
                          </td>
                          <td>
                      <%=resultSet.getString("c_CEO_name") %>
                          </td>
                          <td class="text-primary">
                           INR - <%=resultSet.getString("package")%>
                          </td>
                          
                           <td class="text-primary">
                           <form action="companyMan_action.jsp" method="get">
                       <button name="data" type="submit" class="btn btn-primary"  value= "<%=resultSet.getString("c_Name") %>" >Remove</button>
                       </form>
                          </td>
