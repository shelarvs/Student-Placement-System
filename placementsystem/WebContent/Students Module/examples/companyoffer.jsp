      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo"><b>Upload Company Offer Letter</b></a>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
              	<div class="letter">  
              	<form action="Upload_offer_letter.jsp" method="get">
              <br> <input type="file" name="offer_letter" accept="image/*"><br>
               <button id="btnSubmit" class="btn btn-primary pull-right" >Upload Offer-Letter</button>
                   </form>
            	</div>
