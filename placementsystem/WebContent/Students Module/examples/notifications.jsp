      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo"><b>Notifications</b></a>
          </div>
...
String stud_info_temp ="select * from student_temp";
ResultSet resultSet = statement.executeQuery(stud_info_temp);
resultSet.next();

String temp_mail=resultSet.getString("Email");

String notification_data ="select * from notification where Email='"+temp_mail+"'";
resultSet = statement.executeQuery(notification_data);
...
<div class="alert info">
  ...
  <strong><%=resultSet.getString("Message") %></strong>
</div>
 <%}%>
